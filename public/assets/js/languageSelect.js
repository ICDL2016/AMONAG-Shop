$(function () {
  ...
  function generateSelect(selected, available) {
    ...
    $.each(selected, function (key, value) {
      ...
      var $el;
      if (firstItem) {
        $el = $('<li><div class="select-wrap"><select name="primary" class="js-lang-select"></select></div></li>');
        firstItem = false;
      } else {
        $el = $('<li><div class="select-wrap"><select name="secondary[]" class="js-lang-select"></select></div></li>');
      }
  ...
  function addSelect(available) {
    ...
    var $el = $('<li><div class="select-wrap"><select name=""  class="js-lang-select"></select></div></li>');
    var $select = $el.find('select');
    $('<option value="">Выберите язык</option>').appendTo($select);
